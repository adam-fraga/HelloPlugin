...
namespace PowerApps.Samples
{
  ...
  public sealed class HelloPlugin : IPlugin
  {
    ...
    public void Execute(IServiceProvider serviceProvider)
    {
       ...
       * Contain runtime informations like the user who executing the plugin, 
       * the entity and event on which the plugin is registered and more.
      */
          ...
          context.InputParameters["Target"] is Entity)
      {
         ...
         * An entity is nothing but a generic class that represent 
         * a collection of the attributes send by the form
         * As an exemple if your plugin is registered on Create contact,
         * Here you will get the contact record.
        **/
        Entity entity = (Entity)context.InputParameters["Target"];

        // Can access a specific attribute of the entity if it exists we use exclusively LOGICAL NAME
        string firstname = entity.Attributes["firstname"].ToString();
        // Add data to entity attribute
        entity.Attributes.Add("My lastname", "Fraga");
